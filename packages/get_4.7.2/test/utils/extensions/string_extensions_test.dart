...
void main() {
  group('String extensions', () {
    ...
    test('var.capitalizeAllWordsFirstLetter()', () {
      ...
      expect(sentences[2].capitalizeAllWordsFirstLetter(), "This Is An Example Sentence With A Number 5");
      expect(sentences[3].capitalizeAllWordsFirstLetter(), "This Is An Example Sentence With A Number 5 And A Special Character #");
      expect(sentences[4].capitalizeAllWordsFirstLetter(), "This Is An Example Sentence With A Number 5 And A Special Character # And B Letter C");
      ...
      expect(sentences[7].capitalizeAllWordsFirstLetter(), "This Is A Sentence With All Capital Letters");
