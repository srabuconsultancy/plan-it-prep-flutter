...
class RegisterReminders extends StatelessWidget {
  const RegisterReminders({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final List<ReminderPreference> dummyReminders = [
      ReminderPreference(id: 1, name: "Daily"),
      ReminderPreference(id: 2, name: "Weekly"),
      ReminderPreference(id: 3, name: "No reminders"),
    ];
    // --------------------
                    ...
                    () => Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            "Would you like daily or weekly reminders?", // <-- NEW TITLE
                        ...
                        // --- UPDATED REMINDER MAPPING ---
                        ...dummyReminders.mapIndexed(
                          (reminderItem, i) => Container(
                            width: Get.width,
                            ...
                            authController.selectedReminderPreference.value =
                                reminderItem;
                            authController.selectedReminderPreference.refresh();
                            // ---------------------------------
                          })
                          .animate()
                          .shimmer(
                  ...
                  children: [
                    ...
                    CustomButtonWidget(
                      ...
                      onTap: () {
                        ...
                        if (authController.selectedReminderPreference.value.id <=
                            0) {
                          Get.snackbar(
                            "Error",
                            "Please select a reminder preference.",
