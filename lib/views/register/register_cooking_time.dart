...
class RegisterCookingTime extends StatelessWidget {
  const RegisterCookingTime({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    // --- DUMMY DATA (Removed) ---
    // final List<CookingTime> dummyCookingTimes = [ ... ];
    // --------------------
                  ...
                  child: Obx(
                    () => Column(
                      ...
                      children: [
                        ...
                        Text(
                          "How much time do you usually have to cook?", // <-- NEW TITLE
                          style: TextStyle(
                            fontWeight: FontWeight.w700,
                            fontSize: 14,
                            color: glDarkPrimaryColor,
                        ...
                        // --- UPDATED COOKING TIME MAPPING ---
                        ...RootService.to.config.value.cookingTime.mapIndexed(
                          (cookingTimeItem, i) => Container(
                            width: Get.width,
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: authController.selectedCookingTime.value ==
                                      cookingTimeItem
                                  ? glLightPrimaryColor
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                // --- SINGLE-SELECT UI LOGIC ---
                                if (authController.selectedCookingTime.value ==
                                    cookingTimeItem)
                                  Icon(
                                    Icons.check_circle,
                                    color: glLightThemeColor,
                            ...
                            authController.selectedCookingTime.value =
                                cookingTimeItem;
                            authController.selectedCookingTime.refresh();
                            // ---------------------------------
                          })
                          .animate()
                          .shimmer(
                  ...
                  children: [
                    ...
                    CustomButtonWidget(
                      ...
                      onTap: () {
                        ...
                        if (authController.selectedCookingTime.value.id <= 0) {
                          Get.snackbar(
                            "Error",
                            "Please select your cooking time.",
