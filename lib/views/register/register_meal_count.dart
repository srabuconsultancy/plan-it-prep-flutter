...
class RegisterMealCount extends StatelessWidget {
  const RegisterMealCount({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    // final List<MealCount> dummyMealCounts = [
    //   MealCount(id: 1, name: "2"),
    //   MealCount(id: 2, name: "3"),
    //   MealCount(id: 3, name: "4 or more"),
    // ];
    // --------------------
                    ...
                    () => Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            "How many meals do you want to plan per day?", // <-- NEW TITLE
                        ...
                        // --- UPDATED MEAL COUNT MAPPING ---
                        ...RootService.to.config.value.mealCount.mapIndexed(
                          (mealCountItem, i) => Container(
                            width: Get.width,
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: authController.selectedMealCount.value ==
                                      mealCountItem
                                  ? glLightPrimaryColor
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                // --- SINGLE-SELECT UI LOGIC ---
                                if (authController.selectedMealCount.value ==
                                    mealCountItem)
                                  Icon(
                                    Icons.check_circle,
                                    color: glLightThemeColor,
                              ...
                              .onInkTap(() {
                                ...
                                authController.selectedMealCount.value =
                                    mealCountItem;
                                authController.selectedMealCount.refresh();
                                // ---------------------------------
                              })
                              .animate()
                              .shimmer(
                  ...
                  children: [
                    ...
                    CustomButtonWidget(
                      ...
                      onTap: () {
                        ...
                        if (authController.selectedMealCount.value.id <= 0) {
                          Get.snackbar(
                            "Error",
                            "Please select the number of meals.",
